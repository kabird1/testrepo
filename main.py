...
if 'input_data' not in st.session_state:
    st.session_state.input_data=pd.DataFrame(columns=['A'])
...
#user uploads csv with their labelled data, load into pandas dataframe,
if st.session_state.input_data.empty:
    ...
    if st.session_state.input_data.empty==False and st.session_state.model==None:
        #once user uploaded data, append images from google maps api, split into training and validation set
