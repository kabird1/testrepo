...
if st.session_state.user_file!=None:
    ...
    if len(st.session_state.data.latitude)>0:
        ...
        load_new_image()
        col11, col12, col13, col14, col15, col16 = st.session_state.col1.columns(6)
        ...
        user_edited_data = col2.data_editor(data=st.session_state.data, use_container_width=True)
